...
class OutputFormatterTest extends TestCase
{
     ...
     * @dataProvider provideDecoratedAndNonDecoratedOutput
     */
    public function no_testNotDecoratedFormatterOnIDEALikeEnvironment(string $input, string $expectedNonDecoratedOutput, string $expectedDecoratedOutput, bool $expectsIDEALikeTerminal = false) // TODO strange
    {
