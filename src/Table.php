...
namespace PhacMan\ConsoleTable;
...
use PhacMan\ConsoleTable\Formatter\WrappableOutputFormatterInterface;
...
use PhacMan\ConsoleTable\Helper\TableRows;
...
use PhacMan\ConsoleTable\Output\OutputInterface;
...
class Table
{
    ...
    private OutputInterface|ConsoleOutput $output;
    ...
    public function appendRow(TableSeparator|array $row) : static
    {
        if (!$this->output instanceof ConsoleSectionOutput) {
            ...
            $stream = new StreamOutput($stream, OutputInterface::VERBOSITY_NORMAL, true);
            $sections = [];
            $this->output = new ConsoleSectionOutput($stream->getStream(), $sections, $stream->getVerbosity(), $stream->isDecorated(), new OutputFormatter());
        }
