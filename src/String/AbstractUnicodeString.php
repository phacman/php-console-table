...
namespace PhacMan\ConsoleTable\String;
...
abstract class AbstractUnicodeString extends AbstractString
{
    ...
    private function wcswidth(string $string) : int
    {
        ...
        foreach (preg_split('//u', $string, -1, PREG_SPLIT_NO_EMPTY) as $c) {
            ...
            self::$tableZero ??= require dirname(__DIR__) . '/Resources/data/wcswidth_table_zero.php';
            ...
            self::$tableWide ??= require dirname(__DIR__) . '/Resources/data/wcswidth_table_wide.php';
